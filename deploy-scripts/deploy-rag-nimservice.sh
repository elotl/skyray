...
kubectl label nimservices.apps.nvidia.com/nemoretriever-table-structure-v1  -n ${APP_NAMESPACE} app.kubernetes.io/instance=rag
kubectl label nimservices.apps.nvidia.com/nemoretriever-embedding-ms        -n ${APP_NAMESPACE} app.kubernetes.io/instance=rag
kubectl label nimservices.apps.nvidia.com/nemoretriever-ranking-ms          -n ${APP_NAMESPACE} app.kubernetes.io/instance=rag
