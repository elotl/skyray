...
echo "Place training ray job on static cluster; job runs until terminal state or 600s time-out"
envsubst < ${SKYRAY_PATH}/policies/rayjobstaticpolicy.yaml | kubectl apply -f -
